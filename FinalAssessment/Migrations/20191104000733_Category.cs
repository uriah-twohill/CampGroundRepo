    ...
    public partial class Category : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_dbo.Customers", x => x.CId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PId = table.Column<string>(maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__tmp_ms_x__C57755402EA9ED44", x => x.PId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_dbo.Enrolment", x => x.OId);
                    table.ForeignKey(
                        name: "FK_StdEnrol",
                        column: x => x.CId,
